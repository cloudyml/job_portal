            ...
            child: Stack(
              children: [
                    ...
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                          ...
                          top: 128 * fem,
                          child: Container(
                            padding: EdgeInsets.fromLTRB(25.44 * fem,
                                21.44 * fem, 106 * fem, 21.44 * fem),
                            width: 242 * fem,
                            height: 64 * fem,
                            decoration: const BoxDecoration(
                              color: Color(0xffffffff),
                        ...
                        Positioned(
                          ...
                          child: Container(
                            padding: EdgeInsets.fromLTRB(
                                24.48 * fem, 14 * fem, 15 * fem, 16 * fem),
                            width: 242 * fem,
                            height: 64 * fem,
                            decoration: const BoxDecoration(
                              color: Color(0xffffffff),
                          ...
                          child: Stack(
                            children: [
                              Positioned(
                                ...
                                top: 2 * fem,
                                child: Container(
                                  padding: EdgeInsets.fromLTRB(55.85 * fem,
                                      133 * fem, 8.98 * fem, 25 * fem),
                                  width: 241.36 * fem,
                                  height: 242 * fem,
                                  decoration: const BoxDecoration(
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          ...
                                          style: SafeGoogleFont(
                                            ...
                                            fontWeight: FontWeight.w500,
                                            height: 1.5 * ffem / fem,
                                            color: const Color(0xff464155),
                                          ),
                                        ),
                                      ),
                                      Container(
                                        // lineexu (205:324)
                                        margin: EdgeInsets.fromLTRB(25.93 * fem,
                                            0 * fem, 0 * fem, 0 * fem),
                                        width: 69.82 * fem,
                                        height: 58 * fem,
                                        child: Image.asset(
                                ...
                                child: SizedBox(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        // VyX (205:326)
                                        margin: EdgeInsets.fromLTRB(24.93 * fem,
                                            0 * fem, 0 * fem, 11 * fem),
                                        child: Text(
                                          '-0,5%',
                                          style: SafeGoogleFont(
                                ...
                                child: SizedBox(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        // linen5T (205:330)
                                        margin: EdgeInsets.fromLTRB(33.41 * fem,
                                            0 * fem, 0 * fem, 0 * fem),
                                        width: 145.61 * fem,
                                        height: 32 * fem,
                                        child: Image.asset(
                ...
                Positioned(
                  ...
                  child: Container(
                    padding: EdgeInsets.fromLTRB(
                        56 * fem, 3 * fem, 36.42 * fem, 0.05 * fem),
                    width: 1134 * fem,
                    height: 235 * fem,
                    decoration: BoxDecoration(
                      color: const Color(0xff303c6c),
