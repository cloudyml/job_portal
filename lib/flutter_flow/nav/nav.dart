...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => JobRecommendationWidget(),
        ),
        FFRoute(
          name: 'Contactuspage',
          path: '/contactuspage',
        ...
        //   builder: (context, params) => ApplicantScreenWidget(),
        // ),
        // FFRoute(
        //   name: 'SelectedJobApplicant',
        //   path: '/selectedJobApplicant',
        //   builder: (context, params) => SelectedJobApplicantWidget(),
        // )
